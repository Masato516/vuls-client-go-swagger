...
// IsSuccess returns true when this pkg cpe add cpe o k response has a 2xx status code
func (o *PkgCpeAddCpeOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this pkg cpe add cpe o k response has a 3xx status code
func (o *PkgCpeAddCpeOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this pkg cpe add cpe o k response has a 4xx status code
func (o *PkgCpeAddCpeOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this pkg cpe add cpe o k response has a 5xx status code
func (o *PkgCpeAddCpeOK) IsServerError() bool {
	return false
}

// IsCode returns true when this pkg cpe add cpe o k response a status code equal to that given
func (o *PkgCpeAddCpeOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *PkgCpeAddCpeOK) String() string {
	return fmt.Sprintf("[POST /v1/pkgCpe/cpe][%d] pkgCpeAddCpeOK  %+v", 200, o.Payload)
}
