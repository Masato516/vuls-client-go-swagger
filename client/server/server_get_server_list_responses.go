...
// IsSuccess returns true when this server get server list o k response has a 2xx status code
func (o *ServerGetServerListOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this server get server list o k response has a 3xx status code
func (o *ServerGetServerListOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this server get server list o k response has a 4xx status code
func (o *ServerGetServerListOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this server get server list o k response has a 5xx status code
func (o *ServerGetServerListOK) IsServerError() bool {
	return false
}

// IsCode returns true when this server get server list o k response a status code equal to that given
func (o *ServerGetServerListOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *ServerGetServerListOK) String() string {
	return fmt.Sprintf("[GET /v1/servers][%d] serverGetServerListOK  %+v", 200, o.Payload)
}
