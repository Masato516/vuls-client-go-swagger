...
func (m *PkgCpeAddCpeResponseBody) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateID(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateName(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateServer(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateTasks(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) validateVersion(formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) contextValidateServer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) contextValidateTasks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgCpeAddCpeResponseBody) UnmarshalBinary(b []byte) error {
	var res PkgCpeAddCpeResponseBody
