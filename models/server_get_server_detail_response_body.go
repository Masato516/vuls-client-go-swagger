...
// ServerGetServerDetailResponseBody ServerGetServerDetailResponseBody
...
func (m *ServerGetServerDetailResponseBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServerGetServerDetailResponseBody) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateHostUUID(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateID(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateNeedKernelRestart(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateOsFamily(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateOsVersion(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validatePlatformInstanceID(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validatePlatformName(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateServerIPV4(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateServerName(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateServerUUID(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateServerroleID(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateServerroleName(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateTags(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateTasks(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) contextValidateTasks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServerGetServerDetailResponseBody) UnmarshalBinary(b []byte) error {
	var res ServerGetServerDetailResponseBody
