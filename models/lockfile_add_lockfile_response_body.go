...
// LockfileAddLockfileResponseBody LockfileAddLockfileResponseBody
...
func (m *LockfileAddLockfileResponseBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LockfileAddLockfileResponseBody) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validateFileContent(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validateID(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validateLibraryPkgs(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validatePath(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validateServer(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) contextValidateLibraryPkgs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) contextValidateServer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LockfileAddLockfileResponseBody) UnmarshalBinary(b []byte) error {
	var res LockfileAddLockfileResponseBody
